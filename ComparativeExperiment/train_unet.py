...
def main():
    ...
    # Override transform for validation (hacky but works if we didn't pass transform to split)
    # Actually random_split doesn't allow changing transform easily. 
    # Better to create two datasets with different transforms and use indices.
    ...
    logger = MetricLogger("unet_metrics.csv", ["epoch", "loss", "dice", "iou"])
    ...
    for epoch in range(EPOCHS):
        ...
        torch.save(checkpoint, "unet_checkpoint.pth.tar")
